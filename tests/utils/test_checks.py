...
@pytest.mark.parametrize(
    ("value", "type_"),
    (
        pytest.param(True, float, id="True"),
        pytest.param(1, (bool, float), id="1"),
        pytest.param(1.0, (bool, int), id="1.0"),
    ),
)
def test_check_scalar_type_invalid(value, type_):
...
def test_check_scalar_ge_invalid(value, type_, ge):
...
def test_check_scalar_gt_invalid(value, type_, gt):
...
def test_check_scalar_le_invalid(value, type_, le):
...
def test_check_scalar_lt_invalid(value, type_, lt):
...
def test_check_scalar_eq_invalid(value, type_, eq):
...
def test_check_scalar_ne_invalid(value, type_, ne):
...
def test_check_scalar_in_invalid(value, type_, in_):
...
def test_check_scalar_not_in_invalid(value, type_, not_in):
